...
def main():
        ...
        for fileName in os.listdir(TEST_IMAGES_DIR):
            ...
            for prediction in sortedPredictions:
                ...
                if onMostLikelyPrediction:
                    ...
                    print(strClassification[0:2],"..........",fileName[0:2],"---filename\n\n\n")
                    if fileName[0:2] == 'cl' and strClassification[0:2] == fileName[0:2]:
                        conmatrix.append([1,0,0,0])
                        per = per + 1
                    elif fileName[0:2] == 'cl' and strClassification[0:2] != fileName[0:2]:
                        conmatrix.append([0,1,0,0])
                    elif fileName[0:2] != 'cl' and strClassification[0:2] != fileName[0:2]:
                        conmatrix.append([0,0,1,0])
                    elif fileName[0:2] != 'cl' and strClassification[0:2] == fileName[0:2]:
                        conmatrix.append([0,0,0,1])
                        per = per + 1
    ...
    print("\n\n\nTotal Accuracy from per : ",(per/popnum) * 100.0)
    sum = 0
    for i in conmatrix:
        sum = sum + i[0] + i[3]
    print("\n\n\nTotal Accuracy from sum : ",(sum/popnum) * 100.0)
    print('\n\n\nConclusion Matix : \n')
    for i in conmatrix:
        print(i,'\n')
